...
if __name__ == "__main__":
        ...
        # bonus_df = pd.DataFrame(bonus_results).T.clip(0, 1)
        ...
        combined_df = pd.merge(test_df, pra_df["Summe"], left_index=True, right_index=True, how='outer').fillna(0)
        ...
        combined_df.to_excel("Bonuspunkte_SoSe25.xlsx")
        pass
